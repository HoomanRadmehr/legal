...
urlpatterns = [
    ...
    path("api/v1/", include("apps.activity.api.v1.urls")),
    path("api/v1/", include("apps.organizations.api.v1.urls")),
    path("api/v1/", include("apps.matters.api.v1.urls")),
    ...
    path("api/v1/", include("apps.offboarding.api.v1.urls")),
